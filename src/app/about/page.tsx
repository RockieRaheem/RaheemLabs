...
export default function About() {
  ...
  return <main id="main" className="page-shell about-page">
    <header className="about-hero">
      ...
      <figure className="about-portrait"><Image src="/media/technology-lab.webp" alt="Technology workspace representing the RaheemLabs practice" fill priority sizes="(max-width:760px) 100vw,44vw" /><figcaption><span>RAHEEMLABS / PRACTICE</span><span>UGANDA / EAST AFRICA</span></figcaption></figure>
    </header>
    ...
    <section className="about-accolades section" aria-labelledby="accolades-title"><div data-reveal><p className="eyebrow">Roles & recognition</p><h2 className="section-title" id="accolades-title">Trusted to contribute.</h2><p>Appointments and programmes that reflect the communities I learn from and serve.</p></div><ol>{profile.accolades.map((accolade, index) => <li key={accolade} data-reveal><span>{String(index + 1).padStart(2, "0")}</span><strong>{accolade}</strong></li>)}</ol></section>
